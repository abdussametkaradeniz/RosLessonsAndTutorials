...
(cl:in-package ogreciti_paket-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <GecenZaman-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GecenZaman-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ogreciti_paket-srv:<GecenZaman-request> is deprecated: use ogreciti_paket-srv:GecenZaman-request instead.")))

(cl:ensure-generic-function 'hedef_konum-val :lambda-list '(m))
(cl:defmethod hedef_konum-val ((m <GecenZaman-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ogreciti_paket-srv:hedef_konum-val is deprecated.  Use ogreciti_paket-srv:hedef_konum instead.")
  (hedef_konum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GecenZaman-request>)))
  ...
  "ogreciti_paket/GecenZamanRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GecenZaman-request)))
  "Returns string type for a service object of type 'GecenZaman-request"
  "ogreciti_paket/GecenZamanRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GecenZaman-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GecenZaman-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ogreciti_paket-srv:<GecenZaman-response> is deprecated: use ogreciti_paket-srv:GecenZaman-response instead.")))

(cl:ensure-generic-function 'gecen_sure-val :lambda-list '(m))
(cl:defmethod gecen_sure-val ((m <GecenZaman-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ogreciti_paket-srv:gecen_sure-val is deprecated.  Use ogreciti_paket-srv:gecen_sure instead.")
  (gecen_sure m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GecenZaman-response>)))
  ...
  "ogreciti_paket/GecenZamanResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GecenZaman-response)))
  "Returns string type for a service object of type 'GecenZaman-response"
  "ogreciti_paket/GecenZamanResponse")
