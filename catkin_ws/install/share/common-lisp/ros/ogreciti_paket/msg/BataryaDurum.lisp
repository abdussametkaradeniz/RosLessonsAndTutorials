...
(cl:defmethod cl:initialize-instance :after ((m <BataryaDurum>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BataryaDurum)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ogreciti_paket-msg:<BataryaDurum> is deprecated: use ogreciti_paket-msg:BataryaDurum instead.")))

(cl:ensure-generic-function 'batarya-val :lambda-list '(m))
(cl:defmethod batarya-val ((m <BataryaDurum>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ogreciti_paket-msg:batarya-val is deprecated.  Use ogreciti_paket-msg:batarya instead.")
  (batarya m))
